...
Whistle's Completed:
	1. Whistle 1: adding to bell 2, when the mouse is hovered over a bar chart for x, the corresponding bar for y is highlighted and a tooltip with the x and y values appear.
